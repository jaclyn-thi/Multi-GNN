# Supervised run summary: paysim_native_multigin_core_v1_smoke_seed2
...
- **Validation minority F1 (argmax) at best:** 0.6754
...
- validation AUROC: 0.9816  |  validation AUPRC: 0.6665
...
- Epoch history: `results/diagnostics/supervised_PaySim_paysim_native_multigin_core_v1_smoke_seed2_epoch_history.json`
- Best-val checkpoint (use for reproduction eval): `/home/jthi/ondemand/data/sys/myjobs/projects/Multi-GNN/saved-models/paysim_native_multigin_core_v1_smoke_seed2/checkpoint_best_val_f1.tar`
- Last checkpoint: `/home/jthi/ondemand/data/sys/myjobs/projects/Multi-GNN/saved-models/paysim_native_multigin_core_v1_smoke_seed2/checkpoint_last.tar`
- Flat compatibility checkpoint (= last epoch): `/home/jthi/ondemand/data/sys/myjobs/projects/Multi-GNN/saved-models/checkpoint_paysim_native_multigin_core_v1_smoke_seed2.tar`
