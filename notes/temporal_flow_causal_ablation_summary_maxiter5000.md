...
1_temporal_flow_vs_pre3h_alone. HI ΔAUPRC(C−A)=+0.1781 (modest improvement); LI mean ΔAUPRC(C−A) from per-seed payloads — see multiseed JSON.
2_temporal_flow_vs_pre3h_plus_raw_primary. HI ΔAUPRC(D−B)=+0.1801 (modest improvement); LI mean ΔAUPRC(D−B)=+0.0648 (modest improvement); D beats B on 3/3 LI seeds.
...
- `results/diagnostics/temporal_flow_ablation_small_li_multiseed_maxiter5000.json`
