\begin{table}[t]
\centering
\caption{Appendix — Alert-budget performance}
...
Small-HI & Legacy supervised GIN (100ep seed1) & 0.990 & 0.061 & 530 & 0.966 & 0.300 & 518 & 0.835 & 0.518 & 447 & paper\_argmax F1 \\
...
Small-LI & Legacy supervised GIN (100ep seed1) & 0.970 & 0.121 & 1419 & 0.462 & 0.288 & 676 & 0.270 & 0.337 & 395 & paper\_argmax F1 \\
\bottomrule
\end{tabular}
\footnotetext[1]{Fixed top-K alert-budget metrics on the test split; threshold-tuned precision/recall are omitted.}
\footnotetext[2]{Small-LI SSL rows use mean ± sample SD (ddof=1) over seeds 1–3 where available.}
\footnotetext[3]{K=500 and K=1000 may be unavailable (—) for some multiseed aggregates when not present in registry summaries.}
